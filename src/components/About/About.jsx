            ...
            <div className={`box-about`}>
                    ...
                    <div className={`about-content ${mounted && 'about-content-visible'}`}
                        ...
                        {lang === 'En'
                            ? <p className={`about-text`}>
                                I am a self-taught who found a new passion in programming, I am forming as a Fullstack web developer focused on JavaScript technologies since 2021.<br />
                            ...
                            : <p className={`about-text`}>
                                Soy autodidacta que encontró una nueva pasión en la programación, desde el 2021 estoy formandome como desarrollador web Fullstack orientado a tecnologías Javascript.<br />
                                ...
                                También soy fotógrafo, diciplina que fortaleció mi mirada crítica a la hora de diseñar interfaces para web.
                            </p>}
                ...
                {mounted &&
                    <div className='about-resume-download'>
                        {lang === 'En'
                            ? <a className='link-button' href={'https://drive.google.com/file/d/1HgVnEFz6qLbZ_Zyp288uFw5nA3--bIX8/view'} target='_blank' rel='noreferrer'>{'download resume'}</a>
                            : <a className='link-button' href={'https://drive.google.com/file/d/1GMGpYKMRNpf4J3Rc9I2mwiH4ziS5V_6s/view'} target='_blank' rel='noreferrer'>{'descargar currículum'}</a>}
                    </div>}
